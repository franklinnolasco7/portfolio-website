      ...
      items: [
        {
          ...
          imageUrl: 'website',
          status: 'A personal website to highlight my web development skills and portfolio. It serves as a platform to explore and implement new technologies, expanding my knowledge and creativity',
