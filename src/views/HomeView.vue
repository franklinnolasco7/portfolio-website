<template>
  <main
    ...
    <div class="space-y-2 text-center md:text-left px-10">
      <p class="text-amber-200">Hi there! I'm</p>
      <h1 class="text-4xl font-bold md:text-5xl text-white fadein-up">Franklin Nolasco</h1>
      <div class="py-2">
        <h1
  ...
  <svg
    ...
    <a href="https://drive.google.com/file/d/1m97ohzz4WbP_ibTxgQihO0cG2--bTv5i/view?usp=sharing" target="_blank">Download Resume</a>
  </button>
    </div>
    <div class="flex justify-center md:justify-start fadein-right"><img alt="avatar" fetchpriority="high" width="300" height="300" decoding="async" data-nimg="1"
        class="w-10/12 md:h-auto rounded-full border-4 border-amber-200 pict" src="https://i1.sndcdn.com/avatars-H008eMBeAHKS9aWh-bZ583Q-t500x500.jpg">
    </div>
  </main>
</template>
...
export default {
  ...
  data() {
    return {
      toRotate: ["Computer Engineering Student", "Tech Enthusiast"],
      period: 2000,
      txt: '',
      loopNum: 0,
      isDeleting: false,
